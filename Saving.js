...
function HardReset(){
    ...
    game.rebuyables = [
        [ //Layer
            ...
            [
                [
                    [new Decimal(0), new Decimal(10), new Decimal(0.10), new Decimal(0), new Decimal(10)]
                ],
                [
                    [new Decimal(0), new Decimal(1000), new Decimal(1.50), new Decimal(1.00), new Decimal(10)]
                ],
            ],
        ],
    ]
