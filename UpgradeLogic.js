...
function BuyR3B1(){
    if(game.rebuyables[0][1][0][0][0].gte(game.rebuyables[0][2][0][0][1])){
        [game.rebuyables[0][2][0][0][0], game.rebuyables[0][1][0][0][0]] = BuyUpgrade(0, 2, 0, game.rebuyables[0][1][0][0][0])
        ResetRows(1, null)
    }
}
function BuyR3B2(){
    if(game.points.gte(game.rebuyables[0][2][1][0][1])){
        [game.rebuyables[0][2][1][0][0], game.points] = BuyUpgrade(0, 2, 1, game.points)
